...
const ProfileSetup = () => {
  ...
  const [formDetail, setFormDetail] = useState({
    ...
    phoneNo: '',
    gender: '',
    universityId: 'cm2y6iyjf000012nuny9xua8q',
    wallet_address: '0xea6c44ac03bff858b476bba40716402b03e41b8e97e276d1baec7c37d42484a0'
  })
    ...
    try {
      ...
      const { data: userDetail } = await createUser({
        variables: {
          ...
          wallet_address: formDetail?.wallet_address
        }
      })
